...
},{"./helpers":2,"./ui":3,"babel-polyfill":4}],2:[function(require,module,exports){
'use strict';
...
var setupUI = function UIFactory() {
  ...
  var initEvents = function initUIEvents() {
    $formRegisterCar.on('submit', handleSubmitForm, false);
  };

  var init = function initUI() {
    initEvents();
  };
...
},{"core-js/fn/regexp/escape":6,"core-js/shim":329,"regenerator-runtime/runtime":5}],5:[function(require,module,exports){
(function (global){
/**
...
},{"./_export":37,"./_has":45,"./_hide":46,"./_iter-create":58,"./_iterators":62,"./_library":63,"./_object-gpo":82,"./_redefine":95,"./_set-to-string-tag":102,"./_wks":130}],60:[function(require,module,exports){
var ITERATOR = require('./_wks')('iterator');
